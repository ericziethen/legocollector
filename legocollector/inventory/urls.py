...
urlpatterns = [
    ...
    #path('userparts/<int:pk1>/inventory/new/', views.UserPartInventoryCreateView.as_view(), name='inventory_create'),
    #path('userparts/<int:pk1>/inventory/<int:pk2>/delete/', views.UserPartInventoryDeleteView.as_view(), name='inventory_delete'),
    #path('userparts/<int:pk1>/inventory/<int:pk2>/edit/', views.UserPartInventoryUpdateView.as_view(), name='inventory_edit'),
